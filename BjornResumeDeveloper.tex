...
\begin{ressection}{EXPERIENCE}
    ...
    Developed, as a \lq\lq{}side project\rq\rq{}, a system to enable Beta users to report issues directly from the console and automatically gather supplimental data to help developers understand issues. This became the primary method of filing bugs leading up to, and post, release.  Partnered with developers across the console team to enable them to include their traces and data in the diagnostic data gathered with each bug. }
