...
\begin{ressection}{EXPERIENCE}
    ...
    \ressubitem{Develop features for microsoft.com/store website, including product detail pages for the physical goods and the shopping cart.  Shopping cart is a single page (ember) application.}
    \end{ressubsec}
...
\ressubitem{Web Platforms: ASP.Net, Node.js}
\ressubitem{Debugging: Visual Studio Debugger, kd, gdb, pdb}
\ressubitem{Testing Frameworks: mstest, Nunit, xUnit, pyunit, mocha, jasmine, qunit}
...
\resitem{Building things, learning, game programming, 3D modelling, experimenting with and contributing to, open source software, space, sustainable energy, home improvement, cooking, gardening, pottery, drawing, and playing games of all sorts (athletic, board, and computer based).}
\end{ressection}
